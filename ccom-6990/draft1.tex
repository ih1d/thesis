...
In fact, these extensions are so pervasive that they even alter the execution and
modification of state!\cite{tfmodel} Two surveys (\cite{impact}, \cite{imptograph}) give a taxonomy
of bugs which in some way correlates to programming languages. The cause of bugs can range from
lack of features in a language (e.g. lack of type system guarantees) to a misunderstanding of the 
change of semantics from imperative to graph execution.
